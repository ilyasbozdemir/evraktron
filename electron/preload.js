...
contextBridge.exposeInMainWorld('evraktron', {
  ...
  template: {
    ...
    previewBulkExcel: (templateId) => ipcRenderer.invoke('template:preview-bulk-excel', templateId),
    executeBulkExcel: (templateId, filePath) => ipcRenderer.invoke('template:execute-bulk-excel', templateId, filePath),
